...
class Shell extends Patch
{
    ...
    protected function beforeApply()
    {
        ...
        if (!array_key_exists(Patcher::EXTRA_KEY_MAGE_ROOT_DIR, $extra)) {
            $mageDir = ".";
            $this->getOutput()->writeln('<info>Magento root dir not defined, assumed current working directory</info>');
        } else {
